...
Declare Sub Inivar()
Declare Sub Procser()
Declare Sub Disp_buffer(cntr_seg As Byte)
...
'VAR
Dim Newseg As Bit , Ini_count As Bit
Dim Cntr_seg As Byte , Unidad As Byte , Decena As Byte
Dim Top_value As Byte
Dim Topled As Word
Dim Ini_test1 As Bit , Ini_test As Bit
Dim Cntr_led As Integer
...
'**************************************************************
' Subrutina para actualizar dato de buffer utilizado para almacenar datos de columnas
Sub Disp_buffer(cntr_seg As Byte)
   Print #1 , "$00";
   If Cntr_seg < 10 Then
      Print #1 , "0" ; Cntr_seg
   Else
